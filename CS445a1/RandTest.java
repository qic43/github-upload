...
public class RandTest
{
	public static void main(String [] args)
	{
		...
		// be passed as an argument to the exponential() function.
		
		System.out.print("Enter number of trials: ");
		int num = inScan.nextInt();
		
		// Run this program using usind the same value for both seeds and
	...
	{
		// The average time between arrivals will be 1/lambda.  However,
		// with an exponential distribution there is a lot of variance in
		// the actual arrival gaps.
		double goalAve = 1/lambda;
		double goalMin = goalAve * 60;
		...
		System.out.println("Lambda: " + lambda + " arrivals/hr");
